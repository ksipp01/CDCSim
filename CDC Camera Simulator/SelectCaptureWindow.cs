...
{
    public partial class SelectCaptureWindow : Form
    {
        //public SelectCaptureWindow()
        //{
        //    InitializeComponent();
        //}
        ...
        public void SaveSelection(bool showCursor)
        {
            ...
            SetupDialogForm.Height = bounds.Height;
            SetupDialogForm.Width = bounds.Width;
            SetupDialogForm.xPoint = StartPoint.X;
            SetupDialogForm.yPoint = StartPoint.Y;
        ...
        private void mouse_DClick(object sender, MouseEventArgs e)
        {
            ...
            {
                MessageBox.Show("Capture Area Saved");
                SaveSelection(false);
        ...
        private void SelectCaptureWindow_Load(object sender, EventArgs e)
        {
            MessageBox.Show("Left click and drag mouse over caputre area, then double click to set");
        }
    }
}
